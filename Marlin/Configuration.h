...
#define CUSTOM_MACHINE_NAME "FridayBuilder"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.10, 79.36, 386.79, 409 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 63.8, 0, -1 }
